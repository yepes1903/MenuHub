    ...
    <header class="navbar-section">
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand" href="#"> MenuHub</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-12 col-sm-12 text-content">
                    <h1>La aplicacion de menu que necesitabas</h1>
                    <p>Nosotros te brindamos la posibilidad de visualizar los platos y sus detalles para que no tengas dudas en tu compra.
                    </p>
                    <button class="btn"><a href="#">Ver platos</a></button>
                </div>
